...
final class ChatViewController: QViewController, AVAudioPlayerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private func imageMessage(_ message: QMessage) -> UIView {
        ...
        image.heightAnchor.constraint(equalToConstant: 144).isActive = true
...
final class OtherProfileViewController: RootPageViewController {
    ...
    override func rebuild() {
        ...
        let bio = label(user.bio, size: 11, color: QTheme.secondaryText)
        let info = stack(5)
        [name, handle, bio].forEach { info.addArrangedSubview($0) }
...
final class SettingsViewController: QViewController {
    override func viewDidLoad() {
        ...
        rows.addArrangedSubview(settingRow("me2", fallback: "checkmark.shield", "Privacy Policy", PolicyViewController()))
        rows.addArrangedSubview(settingRow("me3", fallback: "doc.text", "Terms of Service", PolicyViewController(title: "Terms of Service")))
